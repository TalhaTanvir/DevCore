...
function ContactUs() {
  ...
  return (
    <section id="contact-us" className="relative z-10 overflow-hidden bg-[#050814] px-5 py-20 text-white md:px-10 md:py-28">
      ...
      <div className="relative mx-auto w-full max-w-[1312px]">
        <div className="max-w-[760px]">
          <p className="text-[clamp(1.8rem,3.1vw,3.1rem)] font-semibold tracking-[-0.02em]">
            Hey{' '}
            <span className="inline-block border-b-[4px] border-[#f18f3a] pb-[1px] leading-none text-white">Ya&apos;ll!</span>
          </p>
          <h2 className="mt-2 text-[clamp(2rem,4.1vw,4rem)] font-medium leading-[1.06] tracking-[-0.03em]">
        ...
        <div className="mt-10 rounded-[32px] bg-[#f2f2f4] p-6 text-[#111322] shadow-[0_26px_62px_rgba(0,0,0,0.18)] md:p-12">
          <div className="text-[clamp(1.7rem,2.2vw,2.55rem)] font-medium tracking-[-0.02em] text-[#1b1f2d]">
            Area of Interest
          </div>

          <div className="mt-6 flex max-w-[920px] flex-wrap gap-3">
            {interestTags.map((tag, index) => (
              <span
                key={tag}
                className={`rounded-full border px-4 py-[7px] text-[clamp(0.92rem,0.95vw,1.2rem)] leading-none tracking-[-0.01em] ${
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-[1.45fr_0.95fr] md:gap-12">
            <div className="space-y-8">
              <label className="block">
                ...
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full border-b border-[#d0d3db] bg-transparent pb-2 text-[clamp(1.05rem,1.3vw,1.95rem)] text-[#191d2b] placeholder:text-[#a9adb7] focus:outline-none"
                />
              </label>
              <label className="block">
            ...
            <div className="flex flex-col justify-between md:pb-1">
              <div>
                <div className="text-[clamp(2rem,2.3vw,2.75rem)] font-medium tracking-[-0.02em] text-[#151a2a]">
                  Budget
                </div>
              ...
              <div className="mt-12 flex items-center gap-3 md:justify-start">
                <button
                  type="button"
                  className="inline-flex h-[44px] items-center rounded-full border border-[#cfd3dc] bg-[#f7f7f8] px-6 text-[clamp(1.05rem,1.1vw,1.35rem)] font-medium tracking-[-0.02em] text-[#1d2134]"
                >
                  Submit Request
                </button>
                <span className="inline-flex h-[44px] w-[44px] items-center justify-center rounded-full bg-[#2d54f5] text-[1.2rem] text-white">
                  &rarr;
                </span>
              </div>
            </div>
